...
| Archiv      | Bibliothek |
| ----------- | ----------- |
| Unterlagen wurden nicht zum Zweck der Archivierung geschaffen, Archivnutzer nicht im Fokus | Dokument verfasst, um Inhalte an Benutzer zu vermitteln, die genau diese Ihalte suchen    |
| Auswertung von Archivnutzer hat anderen Fokus (historisch) als Aufabe des Produzenten  | Unterstützt Autoren / Leser bei Wissensvermittlung      |
| Dokumenten sind Nachweise der Tätigkeit der Produzenten | Medium der Informationsvermittlung |
