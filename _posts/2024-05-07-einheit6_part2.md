...
### VuFindHarvest
Für die Übungen mit VuFindHarvest arbeiten wir wieder mit einem Codespace auf GitHub (Hier stosse ich auf ein erstes kleines Hindernis, weil ich es nicht auf Anhieb schaffe den Codespace zu starten, weil mir die Option dazu nicht gegeben wird. Ich habe dann gemerkt, dass das daran liegt, dass ich selbst nicht in meinen Account eingeloggt war *face-palm*   :person_frowning:). 
